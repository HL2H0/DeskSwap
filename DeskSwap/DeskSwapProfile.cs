namespace DeskSwap
{
    class DeskSwapProfile
    {
        ...
        public DeskSwapProfile(string name, string description, Dictionary<string, bool> folders, Dictionary<string, bool> files, Dictionary<string,string> originalPaths)
        {
            Name = name;
